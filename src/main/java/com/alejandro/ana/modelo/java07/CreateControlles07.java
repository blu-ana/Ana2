...
import com.alejandro.ana.modelo.CreateControlles;
...
@Scope("singleton")
@Component
public class CreateControlles07 {
    ...
    private int relantizar = 80;
    private int relantizar2 = 150;
...
//            sb.append("\r\n");
    ...
    private StringBuilder createFinBySearch(EntidadesPojo entidad){
        StringBuilder sb5 = new StringBuilder();
                sb5.append("\r\n");
                sb5.append("        @GetMapping(\"/Search\")" + "\r\n");
                sb5.append("        private  List<" + entidad.getNombreClase() + "> finBySearch(@RequestParam(value = \"search\") String search){" + "\r\n");
                sb5.append("            return " + entidad.getNombreClase().toLowerCase() + "Service.search(search);}" + "\r\n");
                sb5.append("\r\n");
        return sb5;
    }
    ...
    private StringBuilder createSalve(EntidadesPojo entidad){
        StringBuilder sb6 = new StringBuilder();
                sb6.append("\r\n");
                sb6.append("        @PostMapping(\"/saveOrUpdate\")" + "\r\n");
                sb6.append("        private Boolean  saveOrUpdate" + entidad.getNombreClase() + "(@RequestBody "+entidad.getNombreClase()+" "+entidad.getNombreClase().toLowerCase() +"){ " + "\r\n");
                sb6.append("            return " + entidad.getNombreClase().toLowerCase() + "Service.saveOrUpdate"
